package com.appsdevelopers.app.ws.mobileappwsrestassured;
...
class TestCreateUser {
  ...
  final void testCreateUser() {
    ...
    shippingAddress.put("city", "Sofia");
    shippingAddress.put("country", "Bulgaria");
    shippingAddress.put("streetName", "Mladost1");
    ...
    userDetails.put("firstName", "Vladimir");
    userDetails.put("lastName", "Stratiev");
    userDetails.put("email", "vladimir@yahoo.com");
